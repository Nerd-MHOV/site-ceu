    ...
    >
      <div className="flex w-full gap-5 items-center justify-end mb-5">
        <Button>
          <a
            href={`/atividades`}
            className="flex flex-row justify-end w-full items-center gap-2"
          >
            <motion.div
              animate={{
                x: [0, 6, 0],
            ...
            <div className="text-white text-[19px] leading-[30px] normal-case font-light">
              Atividades
            </div>
          </a>
        </Button>
