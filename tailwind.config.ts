  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "telescopio-1": "url('/images/hero-bg/telesc-back.jpg')",
        "telescopio-2": "url('/assets/telescopio-2.jpeg')",
        "telescopio-dark": "url('/images/hero-bg/teles-dark.jpg')",
        "telescopio-dark-2": "url('/images/hero-bg/teles-dark-2.jpg')",
        "telescopio-light": "url('/images/hero-bg/teles-light.jpg')",
        "panoramic": "url('/images/hero-bg/panoramic.jpg')",
